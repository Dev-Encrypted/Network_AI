...
This document preserves the v0.2 decisions. For later transport, funded contracts, quotas, complete routes and readiness windows, use the [current manual](README.md) and [current status](STATUS.md).
