...
Root-model/coordinator service supervision, service installation and reboot recovery need their own lifecycle controls. Independent machines, Linux/GPU profiles, WAN/NAT/relay, adversarial verification and sustainable public economics remain separate [acceptance requirements](../planning/12_ROADMAP_AND_BACKLOG.md). The one-computer experiment must not be presented as independent-provider qualification.
