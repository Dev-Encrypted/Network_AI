...
| R07: model above 27B | Complete inference on a pinned, licensed larger-model configuration with measured memory and quality | Official 32.8B Q4_K_M executed; the fixed eight-case CPU and CPU/CUDA campaign accepted five cases per route, with matching errors. Arithmetic/instruction behavior, full context and broader quality remain unresolved |
