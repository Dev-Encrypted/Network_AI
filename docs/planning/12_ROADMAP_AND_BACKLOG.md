...
| R18: broader product | Desktop contributor, localization, model adapters, multimodality and locally bounded coding agent | Standalone private CPU contributor CLI/package available; GUI/service installation, additional hardware/engine profiles and broader product work remain |
